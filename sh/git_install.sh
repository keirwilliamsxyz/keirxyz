...
#//GIT INSTALL////v0.1/////////////////
#//SET VALUES
GIT_USR="keirwilliamsxyz"
GIT_EMAIL="keirwilliams@gmail.com"
EDITOR="nano"
APT="git"
#//HEADER
echo
...
#///CONFIG GITHUB
echo "$L"
echo "$S2 Configure [$APT]"
echo "$L"
git config --global user.email "$GIT_EMAIL"
git config --global user.name "$GIT_USR"
git config --global core.editor "$NANO" 
#///GITHUB SETUP
echo "$S2 git Editor: [$EDITOR]"
echo "$S2 git User: [$GIT_USR]"
echo "$S2 git Email: [$GIT_EMAIL]"
echo "$L"
#//EXIT
echo
echo "$L"
